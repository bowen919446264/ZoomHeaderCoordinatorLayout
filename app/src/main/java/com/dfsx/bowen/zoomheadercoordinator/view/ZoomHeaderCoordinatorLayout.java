...
public class ZoomHeaderCoordinatorLayout extends CoordinatorLayout {
    public static final String TAG = "ZoomHeaderCoordinatorLayout";
    ...
    public ZoomHeaderCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ZoomHeaderCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * ZoomHeaderCoordinatorLayout.sInterpolator.getInterpolation(f1);
